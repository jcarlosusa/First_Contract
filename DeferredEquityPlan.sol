...
contract DeferredEquityPlan {
    ...
    uint annual_distribution = 250; // 250 shares by year, up to 4 years
    ...
    uint unlock_time = now + 365 days; // 365 days = 1 year
    ...
    function distribute() public {
        ...
        require(distributed_shares < total_shares, "Total shares have been distributed.");
